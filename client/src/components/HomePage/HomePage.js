  ...
  return (
    <Container className='mt-5 mb-5'>
      <Card className='col-lg-6'>
        <Card.Img className='img' variant="top" src="https://media.istockphoto.com/photos/wellness-sign-with-wooden-cubes-picture-id513319180?b=1&k=20&m=513319180&s=170667a&w=0&h=vhYdVc-IHZLyS3xqNVuUTcBFpsdJRKPmLzFQpgKnpJY=" />
        <Card.Body>
